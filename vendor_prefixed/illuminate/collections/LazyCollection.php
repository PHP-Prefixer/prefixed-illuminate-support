...
use PPP_L8\Illuminate\Contracts\Support\CanBeEscapedWhenCastToString;
use PPP_L8\Illuminate\Support\Traits\EnumeratesValues;
...
class LazyCollection implements CanBeEscapedWhenCastToString, Enumerable
{
    ...
    public function last(callable $callback = null, $default = null)
    {
        ...
        return $needle === $placeholder ? PPP_L8_value($default) : $needle;
    }
    ...
    public function pluck($value, $key = null)
    {
        return new static(function () use ($value, $key) {
            ...
            foreach ($this as $item) {
                $itemValue = PPP_L8_data_get($item, $value);

                if (is_null($key)) {
                    yield $itemValue;
                } else {
                    $itemKey = PPP_L8_data_get($item, $key);
