...
namespace PPP_L6\Doctrine\Inflector\Rules\Portuguese;

use PPP_L6\Doctrine\Inflector\Rules\Pattern;
use PPP_L6\Doctrine\Inflector\Rules\Substitution;
use PPP_L6\Doctrine\Inflector\Rules\Transformation;
use PPP_L6\Doctrine\Inflector\Rules\Word;
