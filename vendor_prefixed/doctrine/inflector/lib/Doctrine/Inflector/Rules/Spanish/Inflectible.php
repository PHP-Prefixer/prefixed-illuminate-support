...
namespace PPP_L7\Doctrine\Inflector\Rules\Spanish;

use PPP_L7\Doctrine\Inflector\Rules\Pattern;
use PPP_L7\Doctrine\Inflector\Rules\Substitution;
use PPP_L7\Doctrine\Inflector\Rules\Transformation;
use PPP_L7\Doctrine\Inflector\Rules\Word;
