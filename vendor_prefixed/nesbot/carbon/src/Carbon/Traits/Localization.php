...
namespace PPP_L7\Carbon\Traits;

use PPP_L7\Carbon\CarbonInterface;
use PPP_L7\Carbon\Exceptions\InvalidTypeException;
use PPP_L7\Carbon\Exceptions\NotLocaleAwareException;
use PPP_L7\Carbon\Language;
use PPP_L7\Carbon\Translator;
use PPP_L7\Carbon\TranslatorStrongTypeInterface;
use Closure;
use PPP_L7\Symfony\Component\Translation\TranslatorBagInterface;
use PPP_L7\Symfony\Component\Translation\TranslatorInterface;
use PPP_L7\Symfony\Contracts\Translation\LocaleAwareInterface;
use PPP_L7\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;

if (!interface_exists('PPP_L7\\Symfony\\Component\\Translation\\TranslatorInterface')) {
    class_alias(
        'PPP_L7\\Symfony\\Contracts\\Translation\\TranslatorInterface',
        'PPP_L7\\Symfony\\Component\\Translation\\TranslatorInterface'
    );
}
