...
namespace PPP_L8\Symfony\Component\Translation\Extractor;

use PPP_L8\Symfony\Component\Finder\Finder;
...
class PhpExtractor extends AbstractFileExtractor implements ExtractorInterface
{
    ...
    protected $sequences = [
        ...
        [
            'new',
            '\PPP_L8\Symfony\Component\Translation\TranslatableMessage',
            '(',
            self::MESSAGE_TOKEN,
            ',',
            self::METHOD_ARGUMENTS_TOKEN,
